...
#PJM -L "node=48x6x12:torus:strict-io"
#PJM -L "freq=2200"
...
gbs=2304
num_node=3456
hostfile_name="24x2x6x2x3x2_tp${tp}dp${dp}pp${pp}"
...
llio_transfer 13b_pp8_tp3_dp144-no-2ndfs_inner.sh
...
mpirun -n ${num_node} \
  ...
  bash 13b_pp8_tp3_dp144-no-2ndfs_inner.sh "${LP}"

...
# checkpoint setting
CHECKPOINT_PATH=/data/hp190122/share/fujii/checkpoints/llm-jp-v1/code10K_en20K_ja30K.ver2.2/1.3b/dp${DATA_PARALLEL_SIZE}_pp${PIPELINE_MODEL_PARALLEL_SIZE}_tp${TENSOR_MODEL_PARALLEL_SIZE}/ja${JA_PERTCENT}_en${EN_PERTCENT}_code${CODE_PERTCENT}-lr
...
mpirun $DISTRIBUTED_ARGS \
  ...
  --wandb-name "1.3b_dp${DATA_PARALLEL_SIZE}_pp${PIPELINE_MODEL_PARALLEL_SIZE}_tp${TENSOR_MODEL_PARALLEL_SIZE}_gbs${GLOBAL_BATCH_SIZE}_ja${JA_PERTCENT}%_en${EN_PERTCENT}%_code${CODE_PERTCENT}%-lr"

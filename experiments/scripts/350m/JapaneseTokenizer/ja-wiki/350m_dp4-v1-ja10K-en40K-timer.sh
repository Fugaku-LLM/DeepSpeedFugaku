...
CHECKPOINT_PATH=checkpoints/ja-wiki/350m_dp4_v1_ja${JA_VOCAB_SIZE}K_en${EN_VOCAB_SIZE}K-timer
...
mpirun $DISTRIBUTED_ARGS \
  ...
  --wandb-name "timer-ja-wiki-350m_dp4-v1-ja${JA_VOCAB_SIZE}K_en${EN_VOCAB_SIZE}K" \
  --use-timer

...
CHECKPOINT_PATH=checkpoints/ja-wiki/350m_dp4_v1_ja${JA_VOCAB_SIZE}K_en${EN_VOCAB_SIZE}K-timer-flush-denormal
...
JOB_NAME="ja-wiki-350m_dp4-v1-ja${JA_VOCAB_SIZE}K-en${EN_VOCAB_SIZE}K"

mpirun $DISTRIBUTED_ARGS \
  -x TIMER="timer/${JOB_NAME}-${now}" \
  ...
  --wandb-name "timer-flush-denormal-ja-wiki-350m_dp4-v1-ja${JA_VOCAB_SIZE}K_en${EN_VOCAB_SIZE}K" \
  --use-timer \
  --use-flush-denormal

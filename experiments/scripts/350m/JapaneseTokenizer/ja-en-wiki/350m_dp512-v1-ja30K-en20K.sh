...
CHECKPOINT_PATH=checkpoints/ja-en-wiki/350m_dp512_v1_ja${JA_VOCAB_SIZE}K_en${EN_VOCAB_SIZE}K
...
mpirun $DISTRIBUTED_ARGS \
  ...
  --wandb-name "ja-en-wiki-350m_dp512-v1-ja${JA_VOCAB_SIZE}K_en${EN_VOCAB_SIZE}K"

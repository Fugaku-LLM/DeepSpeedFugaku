...
CHECKPOINT_PATH=checkpoints/350m_dp4_sentencepiece-v1
...
DATA_PATH=data/wikipedia/binarized/llm-jp-v1/ja_wiki_text_document
...
mpirun $DISTRIBUTED_ARGS \
  ...
  --wandb-name "ja-wiki-350m_dp4-sentencepiece-v1"

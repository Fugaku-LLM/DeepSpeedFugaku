...
CHECKPOINT_PATH=/data/hp190122/share/fujii/checkpoints/llm-jp-v1/125m_tp2_dp256_v2.1_code${CODE_VOCAB_SIZE}k_en${EN_VOCAB_SIZE}k_ja${JA_VOCAB_SIZE}k/ja${JA_PERTCENT}_en${EN_PERTCENT}_code${CODE_PERTCENT}
...
mpirun $DISTRIBUTED_ARGS \
  ...
  --wandb-name "125m_gb256-dp256-tp2-ja${JA_PERTCENT}_en${EN_PERTCENT}_code${CODE_PERTCENT}"

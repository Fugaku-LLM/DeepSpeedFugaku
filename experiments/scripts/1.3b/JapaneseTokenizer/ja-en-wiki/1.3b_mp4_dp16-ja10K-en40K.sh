...
CHECKPOINT_PATH=checkpoints/ja-en-wiki/1_3b_mp4_dp16_v1_ja${JA_VOCAB_SIZE}K_en${EN_VOCAB_SIZE}K
...
mpirun $DISTRIBUTED_ARGS \
  python pretrain_gpt.py \
    ...
    --wandb-name "ja-en-wiki-1.3b-mp4-dp16-v1-ja${JA_VOCAB_SIZE}K_en${EN_VOCAB_SIZE}K"

...
ja_wiki_weight=0.007893468221
en_wiki_weight=0.02601323263
ja_cc_weight=0.01821332978
en_pile_weight=0.00608859483
code_stack_weight=0

# training setting
train_token_in_billion=204.4
train_token=$(echo "$train_token_in_billion * 1000 * 1000 * 1000" | bc)
train_token=$(echo "$train_token/1" | bc)

lr_warmup_tokens_in_billion=2.044

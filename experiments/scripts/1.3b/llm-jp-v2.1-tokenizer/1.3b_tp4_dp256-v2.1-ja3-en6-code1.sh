...
ja_wiki_weight=0.005223103766
en_wiki_weight=0.01721294234
ja_cc_weight=0.007757286743
en_pile_weight=0.0129508235
code_stack_weight=0.0125

# training setting
train_token_in_billion=309
train_token=$(echo "$train_token_in_billion * 1000 * 1000 * 1000" | bc)
train_token=$(echo "$train_token/1" | bc)

lr_warmup_tokens_in_billion=3.09

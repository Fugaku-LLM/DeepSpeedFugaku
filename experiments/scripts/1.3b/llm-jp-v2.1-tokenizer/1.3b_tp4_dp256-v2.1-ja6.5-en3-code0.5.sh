...
ja_wiki_weight=0.007329649063
en_wiki_weight=0.02415514459
ja_cc_weight=0.01691237766
en_pile_weight=0.006129885676
code_stack_weight=0.00625

# training setting
train_token_in_billion=220.2
train_token=$(echo "$train_token_in_billion * 1000 * 1000 * 1000" | bc)
train_token=$(echo "$train_token/1" | bc)

lr_warmup_tokens_in_billion=2.202

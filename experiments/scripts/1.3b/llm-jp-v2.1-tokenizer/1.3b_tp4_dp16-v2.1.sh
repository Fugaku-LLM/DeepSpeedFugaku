...
CHECKPOINT_PATH=/data/hp190122/share/fujii/checkpoints/llm-jp-v1/1.3b_tp4_dp16_v2.1
...
mpirun $DISTRIBUTED_ARGS \
  ...
  --wandb-name "llm-jp-1.3b_tp4_dp16-v2.1-code${CODE_VOCAB_SIZE}k_en${EN_VOCAB_SIZE}k_ja${JA_VOCAB_SIZE}k"

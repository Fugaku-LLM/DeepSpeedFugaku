...
ja_wiki_weight=0.006964138355
en_wiki_weight=0.02295058978
ja_cc_weight=0.002448312149
en_pile_weight=0.01726776467
code_stack_weight=0.0125

# training setting
train_token_in_billion=231.7
train_token=$(echo "$train_token_in_billion * 1000 * 1000 * 1000" | bc)
train_token=$(echo "$train_token/1" | bc)

lr_warmup_tokens_in_billion=2.317

...
ja_wiki_weight=0.006765829904
en_wiki_weight=0.02229705654
ja_cc_weight=0.01561142553
en_pile_weight=0.006171176521
code_stack_weight=0.0125

# training setting
train_token_in_billion=238.5
train_token=$(($train_token_in_billion * 1000 * 1000 * 1000))

lr_warmup_tokens_in_billion=2.385

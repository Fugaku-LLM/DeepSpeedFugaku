...
#PJM -L "node=2x2x256:strict"
#PJM -L "node=1024"
#PJM --mpi "rank-map-hostfile=rankfile.txt"
#PJM --mpi "proc=1024"
...
CHECKPOINT_PATH=checkpoints/1_3b_mp4_dp256_2x2x256_wrankfile/
...
DISTRIBUTED_ARGS="-np $NNODES -std-proc ${output_path}/stdproc -mca mpi_print_stats 2"

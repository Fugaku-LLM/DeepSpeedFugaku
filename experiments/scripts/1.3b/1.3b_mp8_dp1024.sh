...
CHECKPOINT_PATH=checkpoints/1_3b_mp4_dp1024/
INPUT_PREFIX=dataset
VOCAB_FILE=gpt2-vocab.json
MERGE_FILE=gpt2-merges.txt
DATA_PATH=data/codeparrot/codeparrot_content_document
TENSORBOARD_ARGS="--tensorboard-dir experiments/tensorboard"
pjsub --interact -L "node=12" -L "rscunit=rscunit_ft01" -L "rscgrp=int" -L "elapse=1:00:00" --sparam "wait-time=600" --mpi "proc=12" -x PJM_LLIO_GFSCACHE=/vol0003:/vol0004

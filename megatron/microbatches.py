...
class NumMicroBatchesCalculator(ABC):
    def __init__(self):
        self.num_micro_batches: typing.Optional[int] = None
        self.current_global_batch_size: typing.Optional[int] = None

    def get(self) -> int:
        return self.num_micro_batches  # type: ignore

    def get_current_global_batch_size(self) -> int:
        return self.current_global_batch_size  # type: ignore
